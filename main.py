...
if __name__ == "__main__":
    ...
    themeMenu.add_command(label="Light Theme", command=lambda:playWithText.theme(bgColor="white",textColor="black",titleColor="#3b2664",textAreaColor="white"))
    themeMenu.add_command(label="Dark Theme", command=lambda:playWithText.theme(bgColor="black",textColor="white",titleColor="white",textAreaColor="black"))
    themeMenu.add_command(label="Red Theme", command=lambda:playWithText.theme(bgColor="#870000",textColor="white",titleColor="white",textAreaColor="#b51f1f"))
    themeMenu.add_command(label="Blue Theme", command=lambda:playWithText.theme(bgColor="#072874",
                       textColor="white",
                       titleColor="white",
                       textAreaColor="#1d45a1"))
